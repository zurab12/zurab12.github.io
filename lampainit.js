  ...
  if (e.name == 'main') {
    e.body.find('[data-component="pirate_store"]').on('hover:enter', function() {
      Lampa.Extensions.show({
        store: 'http://192.168.10.37:11440/extensions',
        with_installed: true
      });
    });
  }
...
if (window.appready) addStore();
  ...
  function start() {
    ...
    var plugins_add = [{"url": "http://192.168.10.37/start.js","status": 1,"name": "Start","author": "lampac"},{"url": "http://192.168.10.37:11440/tracks.js","status": 1,"name": "Tracks.js","author": "lampac"},{"url": "http://192.168.10.37/1/tmdb-proxy.js","status": 1,"name": "TMDB Proxy","author": "lampac"},{"url": "http://192.168.10.37:11440/online.js","status": 1,"name": "Онлайн","author": "lampac"},{"url": "http://192.168.10.37:11440/catalog.js","status": 1,"name": "Альтернативные источники каталога","author": "lampac"},{"url": "http://192.168.10.37:11440/sisi.js","status": 1,"name": "Клубничка","author": "lampac"},{"url": "http://192.168.10.37:11440/startpage.js","status": 1,"name": "Стартовая страница","author": "lampac"},{"url": "http://192.168.10.37:11440/sync.js","status": 1,"name": "Синхронизация","author": "lampac"},{"url": "http://192.168.10.37:11440/ts.js","status": 1,"name": "TorrServer","author": "lampac"},{"url": "http://192.168.10.37:11440/backup.js","status": 1,"name": "Backup","author": "lampac"}];
